...
This is a personal portfolio website built using HTML and basic CSS. It features two main pages: a Home page and a Contact page.
...
Purpose:
This project is part of my web development learning journey and demonstrates my ability to build a functional and well-structured website using fundamental technologies.
